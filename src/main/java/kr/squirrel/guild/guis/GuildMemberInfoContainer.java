...
public class GuildMemberInfoContainer extends Container {
    ...
    public GuildMemberInfoContainer(Player player) {
        super(9 * 6, "[ 길드 정보 ]");
        ...
        INVENTORY.setItem(4, ItemUtil.getHeadItem(player.getUniqueId().toString(), player.getName(), null));
